...
const LuxurySense = () => {
  return (
    <div className="px-6 md:py-[110px] py-[30px] bg-[#e8e4df]">
      {/* First Row */}
      <div className="flex flex-col md:flex-row h-auto md:h-[305px] overflow-hidden mb-10">
        {/* Text Section */}
        <div className="w-full md:w-[50%] flex flex-col items-start md:items-end justify-center md:justify-end sm:justify-end  px-5 md:px-10 text-left md:text-right">
        ...
        {/* Image Section */}
        <div className="w-full md:w-[50%] flex justify-start  md:px-2.5 px-5 py-2 md:py-0">
          <img
      ...
      <div className="flex flex-col md:flex-row h-auto md:h-[305px] overflow-hidden">
        {/* Image Section */}
        <div className="w-full md:w-[50%] flex justify-start md:justify-end md:px-2.5 px-5   py-2 md:py-0">
          <img
