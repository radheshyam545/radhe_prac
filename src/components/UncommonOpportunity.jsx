...
const UncommonOpportunity = () => {
  ...
  return (
    ...
    >
      <h1 
      className="sm:text-[4rem] font-saveya text-[#162933]  leading-none  text-[50px] md:text-[110px] font-light"
      data-aos="fade-down"
      >
      ...
      <h1 className="text-[50px] sm:text-[4rem] md:text-[110px] font-saveya text-[#162933] tracking-wide leading-none mt-[10px] md:mt-[28px] font-light  md:mr-[9px]"
      data-aos="fade-down"
      >
        <span className="block md:inline">smartest</span>
      </h1>
      <h1 className="text-[50px] sm:text-[4rem] md:text-[110px] font-saveya text-[#162933] tracking-wide leading-none mb-4 md:mb-8 mt-[10px]  md:mt-[18px] font-light"
      data-aos="fade-down"
      >
        move
      </h1>
      ...
      >
        <h3
          className="font-editorial text-2xl sm:text-3xl md:text-[36px] font-light cursor-pointer text-[#142A33]"
